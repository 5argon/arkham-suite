...
class TeamAssemblerProto$Type extends MessageType<TeamAssemblerProto> {
    constructor() {
        super("TeamAssemblerProto", [
            { no: 1, name: "input_decks_1", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 2, name: "input_decks_2", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 3, name: "input_decks_3", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 4, name: "input_decks_4", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 5, name: "current_team", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 6, name: "picked_assembly", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_PickedAssembly },
            { no: 7, name: "user_patches", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_UserPatch },
...
class TeamAssemblerProto_PickedAssembly$Type extends MessageType<TeamAssemblerProto_PickedAssembly> {
    constructor() {
        super("TeamAssemblerProto.PickedAssembly", [
            { no: 1, name: "decks", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TeamAssemblerProto_PickedAssembly_Deck }
        ]);
    }
