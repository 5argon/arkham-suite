...
class TeamAssemblerProto$Type extends MessageType<TeamAssemblerProto> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated TeamAssemblerProto.InputDeck input_decks_1 */
				1:
					message.inputDecks1.push(
						TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* repeated TeamAssemblerProto.InputDeck input_decks_2 */
				2:
					message.inputDecks2.push(
						TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* repeated TeamAssemblerProto.InputDeck input_decks_3 */
				3:
					message.inputDecks3.push(
						TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* repeated TeamAssemblerProto.InputDeck input_decks_4 */
				4:
					message.inputDecks4.push(
						TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* repeated string current_team */
				5:
					message.currentTeam.push(reader.string());
					break;
				case /* repeated TeamAssemblerProto.PickedAssembly picked_assembly */
				6:
					message.pickedAssembly.push(
						TeamAssemblerProto_PickedAssembly.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* repeated TeamAssemblerProto.UserPatch user_patches */
				7:
...
class TeamAssemblerProto_PickedAssembly$Type extends MessageType<TeamAssemblerProto_PickedAssembly> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			const [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated TeamAssemblerProto.PickedAssembly.Deck decks */
				1:
					message.decks.push(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				2:
					...
					break;
				case /* repeated string patch_adds */
				3:
					message.patchAdds.push(reader.string());
					break;
				case /* repeated string patch_removes */
				4:
