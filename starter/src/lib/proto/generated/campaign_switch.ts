...
class CampaignSwitchProto$Type extends MessageType<CampaignSwitchProto> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated CampaignSwitchProto.Campaign campaigns */
				1:
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				1:
					...
					break;
				case /* CampaignSwitchProto.InputDeck deck_1 */
				2:
					...
					break;
				case /* CampaignSwitchProto.InputDeck deck_2 */
				3:
					...
					break;
				case /* CampaignSwitchProto.InputDeck deck_3 */
				4:
					...
					break;
				case /* CampaignSwitchProto.InputDeck deck_4 */
				5:
