...
class CardInfo$Type extends MessageType<CardInfo> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated CardInfo.CardInfoType card_info_types */
				1:
					...
					break;
				case /* CardInfo.TraitOptions trait_options */
				2:
					...
					break;
				case /* CardInfo.CommitOptions commit_options */
				3:
...
class CardInfo_CommitOptions$Type extends MessageType<CardInfo_CommitOptions> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* CardInfo.CommitOptions.CommitIcon highlight */
				1:
