...
/**
 * @generated from protobuf message CardWithQuantity
 */
...
export interface UpgradeExportProto {
	...
	/**
	 * @deprecated
	 * @generated from protobuf field: string import_deck_url = 4 [deprecated = true]
	 */
	importDeckUrl: string;
	/**
	 * @generated from protobuf field: repeated CardWithQuantity cards_main = 5
	 */
	cardsMain: CardWithQuantity[];
	/**
	 * @generated from protobuf field: repeated CardWithQuantity cards_side = 6
	 */
...
class CardWithQuantity$Type extends MessageType<CardWithQuantity> {
	constructor() {
		super('CardWithQuantity', [
			{ no: 1, name: 'card_id', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
			{ no: 2, name: 'quantity', kind: 'scalar', T: 5 /*ScalarType.INT32*/ }
		]);
	}

	create(value?: PartialMessage<CardWithQuantity>): CardWithQuantity {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.cardId = '';
		message.quantity = 0;
		if (value !== undefined) reflectionMergePartial<CardWithQuantity>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(
		message: CardWithQuantity,
		writer: IBinaryWriter,
		options: BinaryWriteOptions
	): IBinaryWriter {
		/* string card_id = 1; */
		if (message.cardId !== '') writer.tag(1, WireType.LengthDelimited).string(message.cardId);
		/* int32 quantity = 2; */
...
/**
 * @generated MessageType for protobuf message CardWithQuantity
 */
export const CardWithQuantity = new CardWithQuantity$Type();
...
class UpgradeExportProto$Type extends MessageType<UpgradeExportProto> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated UpgradeExportRow upgrade_rows */
				1:
					message.upgradeRows.push(
						UpgradeExportRow.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* UpgradeExportOptions upgrade_export_options */
				2:
				...
				3:
					...
					break;
				case /* string import_deck_url = 4 [deprecated = true] */
				4:
					message.importDeckUrl = reader.string();
					break;
				case /* repeated CardWithQuantity cards_main */
				5:
					message.cardsMain.push(
						CardWithQuantity.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				case /* repeated CardWithQuantity cards_side */
				6:
					message.cardsSide.push(
						CardWithQuantity.internalBinaryRead(reader, reader.uint32(), options)
					);
					break;
				default:
	...
	internalBinaryWrite(
		...
		/* string import_deck_url = 4 [deprecated = true]; */
		if (message.importDeckUrl !== '')
			writer.tag(4, WireType.LengthDelimited).string(message.importDeckUrl);
		/* repeated CardWithQuantity cards_main = 5; */
		for (let i = 0; i < message.cardsMain.length; i++)
			CardWithQuantity.internalBinaryWrite(
				message.cardsMain[i],
				writer.tag(5, WireType.LengthDelimited).fork(),
				options
			).join();
		/* repeated CardWithQuantity cards_side = 6; */
		for (let i = 0; i < message.cardsSide.length; i++)
			CardWithQuantity.internalBinaryWrite(
				message.cardsSide[i],
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				1:
					...
					break;
				case /* string card_left */
				2:
					message.cardLeft = reader.string();
					break;
				case /* string card_right */
				3:
					message.cardRight = reader.string();
					break;
				case /* bool xp_unlocked */
				4:
					message.xpUnlocked = reader.bool();
					break;
				case /* bool cumulative_xp_unlocked */
				5:
				...
				6:
					...
					break;
				case /* int32 cumulative_xp */
				7:
					message.cumulativeXp = reader.int32();
					break;
				case /* string divider_text */
				8:
				...
				9:
					...
					break;
				case /* bool right_custom */
				10:
					message.rightCustom = reader.bool();
					break;
				case /* string right_custom_text */
				11:
					message.rightCustomText = reader.string();
					break;
				case /* int32 right_custom_choice */
				12:
...
class UpgradeExportOptions$Type extends MessageType<UpgradeExportOptions> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* bool simple_list */
				1:
					message.simpleList = reader.bool();
					break;
				case /* bool split_divider */
				2:
					message.splitDivider = reader.bool();
					break;
				case /* string xp_suffix */
				3:
					message.xpSuffix = reader.string();
					break;
				case /* bool ignore_small */
				4:
					message.ignoreSmall = reader.bool();
					break;
				case /* UpgradeExportOptions.Arrow arrow */
				5:
					...
					break;
				case /* UpgradeExportOptions.Headers headers */
				6:
					...
					break;
				case /* UpgradeExportOptions.Columns columns */
				7:
					...
					break;
				case /* UpgradeExportOptions.SimpleListOptions simple_list_options */
				8:
				...
				10:
					...
					break;
				case /* string show_link_text */
				11:
					message.showLinkText = reader.string();
					break;
				case /* UpgradeExportOptions.UpgradeExportStyle upgrade_export_style */
				12:
...
class UpgradeExportOptions_Headers$Type extends MessageType<UpgradeExportOptions_Headers> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* string cost_header */
				1:
					message.costHeader = reader.string();
					break;
				case /* string total_header */
				2:
...
class UpgradeExportOptions_SimpleListOptions$Type extends MessageType<UpgradeExportOptions_SimpleListOptions> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* UpgradeExportOptions.SimpleListOptions.BlockStyle block_style */
				1:
