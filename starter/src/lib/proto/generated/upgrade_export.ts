...
class CardWithQuantity$Type extends MessageType<CardWithQuantity> {
    ...
    create(value?: PartialMessage<CardWithQuantity>): CardWithQuantity {
        ...
        message.quantity = 0;
        if (value !== undefined)
            reflectionMergePartial<CardWithQuantity>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CardWithQuantity): CardWithQuantity {
    ...
    internalBinaryWrite(message: CardWithQuantity, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string card_id = 1; */
        if (message.cardId !== "")
...
class UpgradeExportProto$Type extends MessageType<UpgradeExportProto> {
    constructor() {
        super("UpgradeExportProto", [
            { no: 1, name: "upgrade_rows", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UpgradeExportRow },
            ...
            { no: 5, name: "cards_main", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CardWithQuantity },
            { no: 6, name: "cards_side", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CardWithQuantity }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* ExportOptions export_options */ 3:
                    ...
                    break;
                case /* string import_deck_url = 4 [deprecated = true] */ 4:
                    message.importDeckUrl = reader.string();
                    break;
                case /* repeated CardWithQuantity cards_main */ 5:
                    message.cardsMain.push(CardWithQuantity.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated CardWithQuantity cards_side */ 6:
                    message.cardsSide.push(CardWithQuantity.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: UpgradeExportProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.cardsMain.length; i++)
            CardWithQuantity.internalBinaryWrite(message.cardsMain[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* repeated CardWithQuantity cards_side = 6; */
        for (let i = 0; i < message.cardsSide.length; i++)
            CardWithQuantity.internalBinaryWrite(message.cardsSide[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
